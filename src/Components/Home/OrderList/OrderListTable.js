...
//   const [allowNewTd, setAllowNewTd] = useState(false);
  ...
  useEffect(() => {
    setIsLoading(true);
    api.get("webapi/client_api/all_order.php?p_user="+user?.user_id).then((data) => {
                  ...
                  return (
                    <TableRow key={idx}>
                      ...
                      <TableCell
                        ...
                        align="left"
                      >
                        {item.agent_refer ? item.agent_refer : "-"}
                      </TableCell>
